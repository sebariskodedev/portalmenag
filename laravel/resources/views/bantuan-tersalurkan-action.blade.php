      ...
      <div class="article">
        ...
        <div class="article-content">
            ...
            <figure class="image-square-top top-center-image">
              <img src="{{ asset('bantuan-tersalurkan/' . $bantuan->gambar) }}" alt="Top Right Image">
            </figure>
            ...
            <span class="post-description text-dinamyc-color"><strong>Tipe Bantuan:</strong> {{$bantuan->tipe}}<br><strong>Jenis Bantuan:</strong> {{$bantuan->jenis}}<br><strong>Kategori Bantuan:</strong> {{$bantuan->kategori}}<br><strong>Jumlah Tersalurkan:</strong> {{$bantuan->jumlah_tersalurkan}}<br><strong>Disalurkan pada:</strong> {{$bantuan->tahun}}</span>
