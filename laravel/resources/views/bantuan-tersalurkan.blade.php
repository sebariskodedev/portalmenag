...
<main class="main dinamyc-color">
    ...
    <section id="portfolio" class="portfolio section dinamyc-color">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2 class="text-dinamyc-color-primary">Bantuan Tersalurkan</h2>
      ...
      <div id="news-slider" class="owl-carousel">
        ...
        @foreach ($bantuans as $data)
          <div class="post-slide dinamyc-color-card">
            <div class="post-img">
              <img src="{{ asset('bantuan-tersalurkan/' . $data->gambar) }}" alt="">
              <a href="{{ route('bantuan-tersalurkan-action', ['id' => $data->id]) }}" class="over-layer"><i class="fa fa-link"></i></a>
            </div>
            <div class="post-content dinamyc-color-card">
              <h3 class="post-title">
                <a class="text-dinamyc-color-primary" href="{{ route('bantuan-tersalurkan-action', ['id' => $data->id]) }}">{{$data->nama}}</a>
              </h3>
              ...
              <span class="post-description text-dinamyc-color"><strong>Tipe Bantuan:</strong> {{$data->tipe}}<br><strong>Jumlah Tersalurkan:</strong> {{$data->jumlah_tersalurkan}}<br><strong>Disalurkan pada:</strong> {{$data->tahun}}</span>
              <span class="post-date text-dinamyc-color"><i class="fa fa-clock-o"></i>{{$data->created_at}}</span>
              <a href="{{ route('bantuan-tersalurkan-action', ['id' => $data->id]) }}" class="read-more">selengkapnya</a>
            </div>
          </div>
        @endforeach
