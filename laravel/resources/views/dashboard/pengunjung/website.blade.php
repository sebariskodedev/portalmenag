...
@section('title', 'Pengunjung Website')
...
<section class="section">
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">@yield('title')</h5>
            ...
            <a href="{{ route('pengunjung-website-export.csv') }}" class="add">Export CSV</a>
            </div>
	...
	<table class="table table-bordered border-primarytable-striped table-class" id= "table-id" style="margin-top: 20px;">
        <thead>
            <tr>
                <th scope="col"><b>IP Address</b></th>
        ...
        <tbody>
            @foreach ($pengunjungs as $data)
                <tr>
                    <td class="truncate-text"><span style="text-overflow: ellipsis; max-width: 100px;-webkit-line-clamp: 2;">{{ $data->ip }}</span></td>
                    <td class="truncate-text"><span style="text-overflow: ellipsis; max-width: 10px;-webkit-line-clamp: 2;">{{ $data->created_at }}</span></td>
                    <td>
						<button 
							style="margin: 5px;" 
							type="button" 
							...
							data-ip="{{$data->ip}}"
							data-waktu="{{$data->created_at}}">
							<i class="fa-solid fa-pen"></i> Detail
						</button>
                        {{-- <form class="d-inline" action="/pengunjung/website/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<span><strong>IP Address : </strong><span class="ip"></span></span><br>
					<span><strong>Waktu : </strong><span class="waktu"></span></span><br>
				</div>
...
<script>
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		modal.addEventListener('show.bs.modal', function (event) {
			...
			modal.querySelector('.ip').textContent = ip;
			modal.querySelector('.waktu').textContent = waktu;
