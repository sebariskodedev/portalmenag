          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row g-3" novalidate action="/informasi/berita" enctype="multipart/form-data" method="POST">
                    @csrf
                    <input style="display: block;" type="text" name="tipe" id="tipe" value="{{old('judul', $berita->type)}}" required>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-sm-12">
                            <textarea type="deskripsi1" name="deskripsi1" class="form-control @error('deskripsi1') is-invalid @enderror" id="deskripsi1" placeholder="{{old('judul', $berita->deskripsi1)}}" value="{{old('judul', $berita->deskripsi1)}}" style="height: 100px" required></textarea>
                        </div>
                        @error('deskripsi1')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="input-2" class="col-12">
                        ...
                        <div class="col-sm-12">
                            <textarea type="deskripsi2" name="deskripsi2" class="form-control @error('deskripsi2') is-invalid @enderror" id="deskripsi2" placeholder="{{old('judul', $berita->deskripsi2)}}" value="{{old('judul', $berita->deskripsi2)}}" style="height: 100px" required></textarea>
                        </div>
                        @error('deskripsi2')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
