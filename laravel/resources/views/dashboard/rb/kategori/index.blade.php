...
@section('title', 'Sub Reformasi Birokrasi')
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/rb/kategori/create" class="add">Add Sub Reformasi Birokrasi</a>
          </div>
        ...
        <tbody>
            @foreach ($kategorirbs as $data)
                <tr>
                    ...
                    <td>
                        <img src="{{ asset('kategoriRB/' . $data->gambar) }}" 
                            alt="{{ $data->judul }}" 
                            style="max-width: 150px; max-height: 100px; object-fit: cover;">
                    </td>
                    <td>
                        <form class="d-inline" action="/rb/kategori/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/rb/kategori/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
