      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/rb/data/create" class="add">Add Data RB</a>
          </div>
        ...
        <tbody>
            @foreach ($reformasis as $data)
                <tr>
                    ...
                    <td>
                        <form class="d-inline" action="/rb/data/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/rb/data/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
