      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/pelayanan/uker/create" class="add">Add Unit Kerja</a>
          </div>
        ...
        <tbody>
            @foreach ($ukers as $data)
                <tr>
                    ...
                    <td>
                        <form class="d-inline" action="/pelayanan/uker/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/pelayanan/uker/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
