...
@section('title', 'Bantuan Tersalurkan')
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/admin/bantuan-tersalurkan/create" class="add">Add Bantuan Tersalurkan</a>
          </div>
        ...
        <tbody>
            @foreach ($bantuans as $data)
                <tr>
                    ...
                    <td>
                        <form class="d-inline" action="/admin/bantuan-tersalurkan/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/admin/bantuan-tersalurkan/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
