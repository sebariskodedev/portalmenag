        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Vertical Form -->
                <div id="data-container" style="display: none;" data-content="{{ $mimbar->deskripsi }}"></div>
                <form id="form-berita" class="row g-3" novalidate action="/informasi/mimbar/{{ $mimbar->id }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <input style="display: none;" type="text" name="tipe" id="tipe" value="{{old('judul', $mimbar->type)}}" required>
                    <div class="col-12">
                        <label for="judul" class="form-label">Judul</label>
                        <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" placeholder="Masukkan Judul" value="{{old('judul', $mimbar->judul)}}" required>
                        @error('judul')
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-sm-6">
                            <input type="file" name="gambar1" class="form-control @error('gambar1') is-invalid @enderror" id="gambar1" accept="image/*">
                        </div>
                        @error('gambar1')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="keterangan1" class="form-control @error('keterangan1') is-invalid @enderror" id="keterangan1" placeholder="Masukkan Keterangan gambar 1" value="{{old('judul', $mimbar->keterangan1)}}" required>
                        @error('keterangan1')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-6 input-2 hidden">
                        ...
                        <input type="text" name="keterangan2" class="form-control @error('keterangan2') is-invalid @enderror" id="keterangan2" placeholder="Masukkan Keterangan gambar 2" value="{{old('judul', $mimbar->keterangan2)}}">
                        @error('keterangan2')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="sumber" class="form-control @error('sumber') is-invalid @enderror" id="sumber" placeholder="Masukkan Sumber" value="{{old('sumber', $mimbar->sumber)}}" required>
                        @error('sumber')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-6">
                        ...
                        <input type="text" name="metadata" class="form-control @error('metadata') is-invalid @enderror" id="metadata" placeholder="Masukkan Metadata" value="{{old('metadata', $mimbar->metadata)}}" required>
                        @error('metadata')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-6">
                        ...
                        <input type="text" name="metatitle" class="form-control @error('metatitle') is-invalid @enderror" id="metatitle" placeholder="Masukkan Meta title" value="{{old('metatitle', $mimbar->metatitle)}}" required>
                        @error('metatitle')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-6">
                        ...
                        <input type="text" name="metadeskripsi" class="form-control @error('metadeskripsi') is-invalid @enderror" id="metadeskripsi" placeholder="Masukkan Meta deskripsi" value="{{old('metadeskripsi', $mimbar->metadeskripsi)}}" required>
                        @error('metadeskripsi')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div id="tags-div" class="col-12">
                        ...
                        <input data-tags="{{$mimbar->metatag}}" style="display: none;" type="text" name="metatag" value="{{old('metatag', $mimbar->metatag)}}" id="tags" required>
                        @error('tags')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12" style="padding-bottom: 100px;">
                        ...
                        <input type="hidden" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" placeholder="Masukkan Deskripsi" value="{{old('deskripsi', $mimbar->deskripsi)}}" style="height: 100px" required>
                        @error('deskripsi')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
