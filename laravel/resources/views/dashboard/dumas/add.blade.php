...
@section('title', 'Add Kategori Aduan')
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Vertical Form -->
                <form class="row g-3" novalidate action="/dumas/subjek" method="POST">
                    @csrf
                    <div class="col-6">
                        <label for="name" class="form-label">Judul</label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan Nama Kategori Aduan" value="{{old('name')}}" required>
                        @error('name')
