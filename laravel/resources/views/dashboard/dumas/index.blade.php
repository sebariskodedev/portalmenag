      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/dumas/subjek/create" class="add">Add Kategori Aduan</a>
          </div>
        ...
        <tbody>
            @foreach ($kategoridumass as $data)
                <tr>
                    ...
                    <td>
                        <form class="d-inline" action="/dumas/subjek/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/dumas/subjek/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
