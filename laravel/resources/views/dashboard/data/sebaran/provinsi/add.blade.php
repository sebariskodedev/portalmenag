          ...
          <div class="card">
            <div class="card-header">
              <div class="text-right">
                <a href="/admin/provinsi" class="btn btn-warning btn-sm"><i class="fa-solid fa-arrow-rotate-left"></i>
                  Back
                </a>
              </div>
            </div>
            ...
            <div class="card-body">
                ...
                <!-- Vertical Form -->
                <form class="row g-3" novalidate action="/admin/data-provinsi" method="POST">
                    @csrf
                    <div class="col-6">
                        <label for="name" class="form-label">Judul</label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan Nama Provinsi" value="{{old('name')}}" required>
                        @error('name')
