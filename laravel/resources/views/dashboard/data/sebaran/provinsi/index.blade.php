      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/admin/data-provinsi/create" class="add">Add Provinsi</a>
          </div>
        ...
        <tbody>
            @foreach ($provinsis as $data)
                <tr>
                    ...
                    <td>
                        <form class="d-inline" action="/admin/data-provinsi/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/admin/data-provinsi/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
