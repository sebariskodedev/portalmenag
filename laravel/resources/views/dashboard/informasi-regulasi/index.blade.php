...
@section('title', 'Informasi/Regulasi Penting')
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/admin/informasi-regulasi/create" class="add">Add Informasi/Regulasi</a>
          </div>
	...
	<table class="table table-bordered border-primarytable-striped table-class" id= "table-id" style="margin-top: 20px;">
        ...
        <tbody>
            @foreach ($regulasis as $data)
                <tr>
                    <td class="truncate-text"><span style="text-overflow: ellipsis; max-width: 100px;-webkit-line-clamp: 2;"><?php if($data->kategori == 1){echo 'Informasi';}else{echo 'Regulasi';} ?></span></td>
                    ...
                    <td>
                        <form class="d-inline" action="/admin/informasi-regulasi/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/admin/informasi-regulasi/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
