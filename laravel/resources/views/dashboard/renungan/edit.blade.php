          ...
          <div class="card">
            <div class="card-header">
              <div class="text-right">
                <a href="/informasi/renungan" class="btn btn-warning btn-sm"><i class="fa-solid fa-arrow-rotate-left"></i>
                  Back
                </a>
              </div>
            </div>
            ...
            <div class="card-body">
                ...
                <!-- Vertical Form -->
                <div id="data-container" style="display: none;" data-content="{{ $renungan->deskripsi }}"></div>
                <form id="form-berita" class="row g-3" novalidate action="/informasi/renungan/{{ $renungan->id }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <input style="display: none;" type="text" name="tipe" id="tipe" value="{{old('judul', $renungan->type)}}" required>
                    <div class="col-12">
                        <label for="judul" class="form-label">Judul</label>
                        <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" placeholder="Masukkan Judul" value="{{old('judul', $renungan->judul)}}" required>
                        @error('judul')
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="keterangan1" class="form-control @error('keterangan1') is-invalid @enderror" id="keterangan1" placeholder="Masukkan Keterangan gambar 1" value="{{old('judul', $renungan->keterangan1)}}" required>
                        @error('keterangan1')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-6 input-2 hidden">
                        ...
                        <input type="text" name="keterangan2" class="form-control @error('keterangan2') is-invalid @enderror" id="keterangan2" placeholder="Masukkan Keterangan gambar 2" value="{{old('judul', $renungan->keterangan2)}}">
                        @error('keterangan2')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-12" style="padding-bottom: 100px;">
                        ...
                        <input type="hidden" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" placeholder="Masukkan Deskripsi" value="{{old('deskripsi', $renungan->deskripsi)}}" style="height: 100px" required>
                        @error('deskripsi')
                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                        @enderror
                    </div>
