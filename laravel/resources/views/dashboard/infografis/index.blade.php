      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="search-add">
            <a href="/admin/infografis/create" class="add">Add Infografis</a>
          </div>
        ...
        <tbody>
            @foreach ($infografiss as $data)
                <tr>
                    ...
                    <td>
                        <img src="{{ asset('infografis/' . $data->gambar) }}" 
                            alt="{{ $data->judul }}" 
                            style="max-width: 150px; max-height: 100px; object-fit: cover;">
                    </td>
                    <td>
                        <form class="d-inline" action="/admin/infografis/{{ $data->id }}/edit" method="GET">
                            <button style="margin: 5px;" type="submit" class="btn btn-success btn-sm mr-1">
                                <i class="fa-solid fa-pen"></i> Edit
                            </button>
                        </form>
                        <form class="d-inline" action="/admin/infografis/{{ $data->id }}" method="POST">
                            @csrf
                            @method('delete')
