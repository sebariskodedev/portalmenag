...
<main class="main dinamyc-color">
    ...
    <section id="portfolio" class="portfolio section dinamyc-color">
		...
		<h2 class="text-dinamyc-color-primary">Dataset</h2>
						...
						@foreach ($datasets as $data)
							<div class="list-item">
								<div class="list-item__content">
									...
									<span class="list-item__info text-dinamyc-color">{{$data->deskripsi}}</span>
                                    <br>
									<a style="background-color: green; padding: 10px 20px; border-radius: 3px;" href="{{ route('dataset-action', ['id' => $data->id]) }}"><span style="color: white;">xlsx</span></a>
								</div>
							</div>
						@endforeach
					</div>
