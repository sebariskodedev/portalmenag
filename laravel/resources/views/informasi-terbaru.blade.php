...
<main class="main dinamyc-color">
    ...
    <section id="portfolio" class="portfolio section dinamyc-color">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2 class="text-dinamyc-color-primary">Berita Terbaru</h2>
      ...
      <div class="container">
            <div class="containerx">
                <div class="row">
                    <form class="search" action="/berita-terbaru" autocomplete="on">
                        <input id="search" name="search" type="text" placeholder="Cari berita .....">
                    </form>
