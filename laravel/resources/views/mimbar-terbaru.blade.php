        ...
        @foreach ($mimbars as $data)
          <div class="post-slide dinamyc-color-card">
            <div class="post-img">
              ...
              <a href="{{ route('article-page', ['kategori' => 'mimbar', 'id' => $data->id]) }}" class="over-layer"><i class="fa fa-link"></i></a>
            </div>
            <div class="post-content dinamyc-color-card">
              <h3 class="post-title">
                <a class="text-dinamyc-color-primary" href="{{ route('article-page', ['kategori' => 'mimbar', 'id' => $data->id]) }}">{{$data->judul}}</a>
              </h3>
              ...
              <a href="{{ route('article-page', ['kategori' => 'mimbar', 'id' => $data->id]) }}" class="read-more">selengkapnya</a>
            </div>
          </div>
        @endforeach
